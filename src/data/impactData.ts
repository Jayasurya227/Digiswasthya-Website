 ...
 * 
 * NOTE FOR PRODUCTION:
 * To integrate with real production databases (e.g., Supabase, Firebase Firestore, or custom REST APIs),
 * these metrics can be fetched dynamically in a Next.js Server Component or inside a React useEffect hook
 * and used to replace the static object below.
 */
export const impactData: ImpactPageData = {
    ...
    kpis: [
        ...
        },
        {
            ...
            label: {
                ...
                hi: "स्वास्थ्य एवं जागरूकता शिविर"
            },
            icon: "Activity",
            description: {
        ...
        },
        {
            ...
            value: 133,
            label: {
                en: "CHC/PHC Health Camps",
                hi: "सीएचसी/पीएचसी स्वास्थ्य शिविर"
            },
            icon: "Building",
            description: {
        ...
        },
        {
            ...
            value: 213,
            label: {
                en: "Expert Doctors Onboard",
                hi: "विशेषज्ञ डॉक्टर संबद्ध"
            },
            icon: "HeartHandshake",
            description: {
    ...
    growthTrends: [
        ...
        { year: "2025", patients: 117644, camps: 2146, doctors: 213 }
    ],
    diseaseDistribution: [
        {
            name: { en: "General Medicine / Primary Ailments", hi: "सामान्य चिकित्सा / प्राथमिक रोग" },
            value: 35,
            color: "#1e7e42" // Primary 500
        },
        {
            name: { en: "Cardiovascular / Hypertension", hi: "हृदय रोग / उच्च रक्तचाप" },
            value: 18,
            color: "#b45309" // Secondary 600
        },
        {
            name: { en: "Diabetes & Endocrine", hi: "मधुमेह और अंतःस्रावी" },
            value: 15,
            color: "#0f3a1f" // Primary 800
        },
        {
            name: { en: "Pediatrics & Child Health", hi: "बाल रोग और बाल स्वास्थ्य" },
            value: 12,
            color: "#fbbf24" // Secondary 400
        },
        {
            name: { en: "Ophthalmology / Eye Care", hi: "नेत्र रोग / आंखों की देखभाल" },
            value: 10,
            color: "#3d9b5e" // Primary 400
        },
        {
            name: { en: "Other Specialties", hi: "अन्य विशिष्टताएं" },
            value: 10,
    ...
    timeline: [
        {
            year: "2020",
            title: { en: "Organization Founded", hi: "संगठन की स्थापना" },
            description: {
        ...
        {
            year: "2023",
            title: { en: "Telemedicine Program Launch", hi: "टेलीमेडिसिन कार्यक्रम का शुभारंभ" },
            description: {
                en: "Inaugurated dedicated digital teleconsultation nodes linking rural centers with specialist doctors in Tier 1 cities.",
