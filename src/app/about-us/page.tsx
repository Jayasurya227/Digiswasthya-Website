...
export default function AboutUs() {
    ...
    return (
        <main className="min-h-screen bg-[#f8fafc]">
            ...
            <section className="relative bg-gradient-to-br from-[#f0f7ff] via-[#fafaf9] to-[#e2f1fc] border-b border-blue-100/60 py-20 lg:py-28 overflow-hidden">
                <div className="absolute inset-0 opacity-[0.07] pointer-events-none">
                    <div className="absolute inset-0 bg-[radial-gradient(#3b82f6_1.5px,transparent_1.5px)] [background-size:24px_24px]" />
                </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        <div className="space-y-6 text-center lg:text-left">
                            <motion.span
                                ...
                                className="inline-block bg-primary-100/70 border border-primary-200/50 text-primary-800 text-[10px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full"
                            >
                            ...
                            >
                                {currentLang === "hi" ? (
                                    <>
                                        ...
                                        <span className="text-primary-600 font-extrabold">सभी के लिए</span>
                                    </>
                                ) : (
                                    <>
                                        Quality Healthcare <br />
                                        <span className="text-primary-600 font-extrabold">For Everyone</span>
                                    </>
                                )}
                            </motion.h1>
                            <motion.p
                                ...
                                className="text-slate-700 text-base md:text-lg font-normal leading-relaxed text-justify"
                            >
                        ...
                        <motion.div
                            ...
                            className="relative h-[300px] md:h-[400px] lg:h-[450px] rounded-3xl overflow-hidden shadow-xl border border-blue-100/60"
                        >
                            <Image
                ...
                <div className="container max-w-7xl px-4">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="relative h-[280px] sm:h-[350px] md:h-[400px] rounded-3xl overflow-hidden shadow-lg border border-gray-100 order-2 lg:order-1"
                        >
                            <Image
                        ...
                        <div className="space-y-8 order-1 lg:order-2">
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                {contentDict.section2.challenges.map((challenge, index) => {
                                    ...
                                    return (
                                        <div key={index} className="flex gap-4 p-5 rounded-2xl bg-slate-50 border border-slate-100/60 shadow-sm">
                                            <div className="w-10 h-10 rounded-xl bg-red-100/70 flex items-center justify-center shrink-0">
                                                <Icon className="w-5 h-5 text-red-600" />
                                            </div>
                                            <div className="space-y-1">
                                                <h4 className="text-sm font-bold text-gray-900">{challenge.title[currentLang]}</h4>
                                                <p className="text-xs font-medium text-gray-500 leading-relaxed">{challenge.desc[currentLang]}</p>
                                            </div>
                                        </div>
                                    );
                                })}
            ...
            <section className="py-24 bg-[#f8fafc] border-b border-gray-150/50">
                <div className="container max-w-7xl px-4">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
                        <div className="space-y-6">
                            ...
                            <h2 className="text-3xl md:text-4xl font-serif font-bold text-gray-900 leading-tight text-center lg:text-left">
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: true }}
                            className="relative h-[280px] sm:h-[350px] md:h-[400px] rounded-3xl overflow-hidden shadow-lg border border-gray-100"
                        >
                            <Image
                    ...
                    <div className="mt-20 pt-16 border-t border-gray-200/70">
                        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="relative h-[300px] sm:h-[380px] lg:h-[450px] rounded-3xl overflow-hidden shadow-lg border border-gray-100"
                            >
                                <Image
                    ...
                    <div id="sandeeps-story" className="max-w-6xl mx-auto scroll-mt-24">
                        <div className="grid lg:grid-cols-[1.6fr_1.1fr] gap-12 items-start">
                            <motion.div
                                ...
                                className="space-y-6"
                            >
                                <h3 className="text-2xl md:text-3xl font-black text-gray-900 tracking-tight underline decoration-primary-200 underline-offset-8">Sandeep's Story</h3>
            ...
            <section className="py-24 bg-white border-b border-gray-150/30">
                <div className="container max-w-7xl px-4">
                        ...
                        {contentDict.section7.cards.map((card, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    whileInView="visible"
                                    viewport={{ once: true }}
                                    className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm flex flex-col group cursor-default hover:shadow-md transition-shadow"
                                >
            ...
            <section className="py-20 bg-[#f8fafc]">
                <div className="container max-w-6xl px-4">
                    <div className="grid lg:grid-cols-2 gap-16 items-center border-b border-gray-200/50 pb-20">
                        <div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-3 text-gray-700 bg-white p-4 rounded-xl border border-gray-150 shadow-sm">
