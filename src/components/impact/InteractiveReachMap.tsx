...
export function InteractiveReachMap() {
    ...
    const [selectedStateId, setSelectedStateId] = useState<string>("mh"); // Default to Maharashtra
    const [hoveredStateId, setHoveredStateId] = useState<string | null>(null);

    const selectedState = REACH_DATA[selectedStateId] || null;
                    ...
                    <div className="lg:col-span-7 flex justify-center items-center relative min-h-[500px]">
                        ...
                        >
                            ...
                            {indiaStates.map((state) => {
                                const isActive = !!REACH_DATA[state.id];
                                ...
                                return (
                                    <path
                                        ...
                                        className={`transition-all duration-300 ${
                                            isActive 
                                                ? `${REACH_DATA[state.id].color} cursor-pointer opacity-90 hover:opacity-100` 
